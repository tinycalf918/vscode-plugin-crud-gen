...
function activate(context) {
    ...
    let disposable = vscode.commands.registerCommand('crud-gen.openPanel', (uri) => {
        // The code you place here will be executed every time your command is executed
        const panel = vscode.window.createWebviewPanel('crudEditor', 'CRUD Editor', vscode.ViewColumn.One, {
            enableScripts: true
        });
